...
/**
 * @author liushjia
 * @date   2015年11月19日 上午10:45:11
 */
public class ZhCommentGen  implements CommentGenerator{
...
//	        xmlElement.addElement(new TextElement("-->")); //$NON-NLS-1$
	    ...
	    public void addFieldComment(Field field,
	        ...
	        if(com.mysql.jdbc.StringUtils.isNullOrEmpty(introspectedColumn.getRemarks())){
	        	return ; 
	        }
